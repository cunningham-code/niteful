...
import '2_thankful_form.dart';

/*

See the origional here: https://github.com/mrzasoltani/Springy-Slider/blob/master/lib/main.dart
...
class _DayPageState extends State<DayPage> {
        ...
        floatingActionButton: FloatingActionButton(
          ...
          child: new IconButton(
            onPressed: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => ThankfulForm()),
              );
            },
  ...
  void _getDayValue() async {
    try {
      print("WIDGET: " + widget.toString());
      print("WIDGET.STORAGE: " + widget.storage.toString());
      SharedPreferences prefs = await SharedPreferences.getInstance();
      int i = prefs.getInt("tempDayValue");
      if (i == -1) {
        i = 50;
      }
      print("DAILY VALUE IS " + i.toString());

      widget.storage.addDailyValue(i);
      i = -1;
      prefs.setInt("tempDayValue", i);
    } catch (e) {
      print("ERROR: " + e);
    }
  }
...
class Points extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final displayPoints = (points / 10).floor();
...
class SpringySliderController extends ChangeNotifier {
  ...
  void onDragEnd() {
    ...
    _tempSaveSliderPercent((_sliderPercent * 100).toInt());
  ...
  void _tempSaveSliderPercent(int i) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setInt("tempDayValue", i);
  }
